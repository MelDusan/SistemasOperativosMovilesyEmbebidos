package com.example.h3procesualmeldmejiag.Activities;
...
public class CalculadoraCientificaActivity extends AppCompatActivity implements  View.OnClickListener{
    private Spinner spinner1;
    public TextView display, ptxvusername;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String [] opciones = {"sin","cos","tan","sec"};
    ...
    private  void initializeComponents(){
        ...
        Button poten=(Button) findViewById(R.id.btnPotenciax2);
        poten.setOnClickListener(this);
        Button poten3=(Button) findViewById(R.id.btnPotenciax3);
        ...
        Button parentesis=(Button) findViewById(R.id.btnParentesisIsquierdo);
        parentesis.setOnClickListener(this);
        Button parentesis2=(Button) findViewById(R.id.btnParentesisDerecho);
        ...
        try{
            switch (seleccion){
                ...
                case R.id.btnPunto:
                    ...
                    break;
                case R.id.btnParentesisIsquierdo:
                    if (parentesis==false){
                        display.setText(a+"(");
                        decimal = true;
                    }else {
                    ...
                    break;
                case R.id.btnParentesisDerecho:
                    if (parentesis==false){
                        display.setText(a+")");
                        decimal = true;
                    }else {
